...
export default function FormLayout() {
  ...
  const getUserDataByFirstname = (firstname) => {
      try {
  ...
  return (
    <>
              ...
              <div className="shadow overflow-hidden sm:rounded-md">
                ...
                <div className="px-4 py-3 bg-gray-50 text-right sm:px-6">
                  ...
                  <button
                    ...
                    className="inline-flex mx-1 justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
                    Reset
                  </button>
                </div>
      ...
      <div className="flex">
          <p className=" inline-flex items-center whitespace-nowrap">ค้นหาข้อมูล</p>
        <input
        onChange={(e  )=> setSearch(e.target.value)}
          ...
          id="search"
          autoComplete="search"
          className="mt-1 focus:ring-indigo-500 my-2 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
        />
        <button 
        onClick={() => getUserDataByFirstname(search)}
        className=" mx-1 justify-center my-1 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-800 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          search
        </button>
      </div>
      <Table
